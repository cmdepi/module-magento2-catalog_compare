...
This little development allows you to configure if the [product compare](https://docs.magento.com/user-guide/marketing/product-compare.html) feature is enabled.
...
In order to find documentation on the use and related issues, visit the [official page](https://binacommerce.com/product-compare.html) of this development.
